# -*- coding: utf-8 -*-
"""LABORATORIO_Enunciado.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1oQfkdAMil7JC9XQZY9MxJu2WyHnaGKKL
...
def estadistica_descriptiva(lista:list):
  ...
  media=0
  if (cantidad%2==1):
    media=data[cantidad/2]
  else:
    media=(data[cantidad//2]+data[(cantidad//2)-1])
  desviacion=[(x-promedio)**2 for x in lista]

  return cantidad,promedio,media,desviacion
